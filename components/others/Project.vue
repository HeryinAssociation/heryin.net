...
const cardContent = [
  ...
  {
    title: 'MC 服务器运维',
    text: '我们以公益性和社区性为主要导向，面向广大MC 社区提供服务器运营、托管、技术支援等各类服务。',
    icon: icons.icon2,
  },
  {
    title: '融媒体事业',
    text: '和瑛社完善的视效工作流，丰富多彩的数字创意，以融媒体事业高质量发展，赋能社区繁荣。',
    icon: icons.icon3,
  },
  {
    title: '数字创意',
    text: '我们重视创意驱动，通过各种方式激励创意创造，推动创意-创新-创业的进程',
    icon: icons.icon4,
  },
  {
    title: '体素艺术',
  ...
  {
    title: '人文研究',
    text: '以社区性为导向主要涵盖输出社区观点、撰写学术论文、参加各类相关赛事。',
    icon: icons.icon6,
  },
]
</script>
